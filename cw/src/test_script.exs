...
test_suite = [
  ...
  {&PaxosTest.run_simple_2/3, get_dist_config.(3), 1, "No failures, 2 concurrent ballots"},
  ...
  {&PaxosTest.run_minority_non_leader_crash/3, get_dist_config.(5), 1,
   "Minority non-leader crashes, no concurrent ballots"},
  {&PaxosTest.run_leader_crash_simple/3, get_dist_config.(5), 1,
